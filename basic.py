    ...
    def if_expr_c(self):
        ...
        if self.current_tok.matches(TT_KEYWORD, "ELSE"):
            ...
            if self.current_tok.type == TT_NEWLINE:
                ...
                statements = res.resgister(self.statements())
                if res.error:
                    return res
...
class BuiltInFunction(BaseFunction):
    ...
    def execute_pop(self, exec_ctx):
        list_ = exec_ctx.symbol_table.get("list")
        index = exec_ctx.symbol_table.get("indes")
        ...
        try:
            ...
            return RTResult().failure(
                RTError(
                    self.pos_start,
                    self.pos_end,
                    "Element at this index could not be removed from list beacuse index is out of bounds",
                    exec_ctx,
                )
            )
...
global_symbol_table.set("RUN", BuiltInFunction.len)
